...
class MaterialHeaderWidget extends StatelessWidget {
  const MaterialHeaderWidget({super.key});
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${controller.filteredMaterials.length} material(s) encontrado(s)',
                      style: TextStyle(
                        fontSize: 14,
              ...
              Row(
                children: [
                  ...
                  ElevatedButton.icon(
                    onPressed: controller.goToCreateMaterial,
